...
import java.util.*;
    @Slf4j
    public class MybatisGeneratorAll {
        ...
        // 自定义值
        private static String author = "wyc";
        private static String ip = "localhost";
        private static String port = "3306";
        private static String dbname = "sys"; // 数据库名
        private static String url = "jdbc:mysql://localhost:3306/sys?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
        private static String driver = "com.mysql.cj.jdbc.Driver";
        private static String username = "root";
        private static String password = "root";

        private static String[] dbTableNames = {}; // 无值：为数据库中所有表生成代码；有值 如：{"table1","table2"}，只生成数组中的表
        private static String javaPackageName = "com.nk.springboot"; // 顶级包名
        ...
        static {
            url = "jdbc:mysql://"
                    +ip+":"
                    +port+"/"
                    +dbname+"?useUnicode=true&useSSL=false&characterEncoding=utf8&serverTimezone=UTC";
        }
...
//            pc.setModuleName(javaModuleName);
            pc.setParent("com.nk.springboot");
            pc.setEntity("entity");
            pc.setMapper("mapper");
